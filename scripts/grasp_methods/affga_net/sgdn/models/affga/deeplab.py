...
from grasp_methods.affga_net.sgdn.models.affga.sync_batchnorm.batchnorm import SynchronizedBatchNorm2d
from grasp_methods.affga_net.sgdn.models.affga.hasp import build_hasp
from grasp_methods.affga_net.sgdn.models.affga.decoder import build_decoder
from grasp_methods.affga_net.sgdn.models.affga.backbone import build_backbone


class DeepLab(nn.Module):
    def __init__(self, input_channels, angle_cls=18, backbone='resnet', output_stride=16, num_classes=21, sync_bn=False,
                 freeze_bn=False, size=320):
        super(DeepLab, self).__init__()
        BatchNorm = nn.BatchNorm2d

        self.backbone = build_backbone(input_channels, backbone, output_stride, BatchNorm)      # 主干网络

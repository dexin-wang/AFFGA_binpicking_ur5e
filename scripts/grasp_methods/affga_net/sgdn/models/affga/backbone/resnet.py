...
class ResNet(nn.Module):
    def __init__(self, input_channels, block, layers, output_stride, batchNorm, pretrained=True):
        """
    ...
    def _load_pretrained_model(self):
        ...
        pretrain_dict = torch.load('/home/wangdx/research/affga_net/NN/resnet101-5d3b4d8f.pth')
        model_dict = {}
...
def ResNet101(input_channels, output_stride, BatchNorm, pretrained=False):
    ...
    """
    model = ResNet(input_channels, Bottleneck, [3, 4, 23, 3], output_stride, BatchNorm, pretrained=pretrained)
    return model
